...
export enum UpdateOPCodes {
   ...
   *
   * The `value` parameter defines the value to add. For more information, see [4.1. add](https://datatracker.ietf.org/doc/html/rfc6902#section-4.1).
   */
  ADD = "add",
  /**
   * Removes the value at the target location. For the operation to succeed, the target location must exist. For more information, see [4.2. remove](https://datatracker.ietf.org/doc/html/rfc6902#section-4.2).
   */
  REMOVE = "remove",
  /**
   * Replaces the value at the target location with a new value. The operation object must contain a `value` parameter that defines the replacement value. For the operation to succeed, the target location must exist. For more information, see [4.3. replace](https://datatracker.ietf.org/doc/html/rfc6902#section-4.3).
   */
  REPLACE = "replace",
  /**
   * Removes the value at a specified location and adds it to the target location. The operation object must contain a `from` parameter, which is a string that contains a JSON pointer value that references the location in the target document `from` which to move the value. For the operation to succeed, the from location must exist. For more information, [see 4.4. move](https://datatracker.ietf.org/doc/html/rfc6902#section-4.4).
   */
  MOVE = "move",
  /**
   * Copies the value at a specified location to the target location. The operation object must contain a from parameter, which is a string that contains a JSON pointer value that references the location in the target document from which to copy the value. For the operation to succeed, the from location must exist. For more information, see [4.5. copy](https://datatracker.ietf.org/doc/html/rfc6902#section-4.5).
   */
  COPY = "copy",
  /**
...
export namespace Endpoints {
  ...
  export const ORDER_DETAILS = (id: string) => `${ORDER_CHECKOUT}/${id}`;
}
